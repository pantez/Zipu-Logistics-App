...
import 'package:login/components/CustomTextStyle.dart';
import 'package:login/components/CustomUtils.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  createCategoryList() {
    listCategory.add("Fruits & Vegetables");
    listCategory.add("Groceries");
    listCategory.add("medicines");
